const translations = {
  ...
  ru: {
    ...
    aboutText1: 'Premiumy приносит премиальные натуральные продукты в сердце Гизы. Используя тщательно отобранные местные ингредиенты, мы создаём продукты, которые отражают качество, аутентичность и страсть к совершенству.',
    aboutText2: 'Как молодой и амбициозный семейный бизнес, мы вдохновляемся египетскими вкусами, сезонными урожаями и радостью создания продуктов, которые одновременно вкусны и питательны.',
    aboutText3: 'Каждый продукт создан с заботой, чтобы объединить натуральную пользу, утончённый вкус и премиальный опыт, которому можно доверять.',
