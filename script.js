const translations = {
  ...
  ar: {
    ...
    aboutText1: 'يقدم بريميومي منتجات طبيعية مميزة في قلب الجيزة. باستخدام مكونات محلية مختارة بعناية، ننشئ منتجات تعكس الجودة، الأصالة، وشغف التميز.',
    aboutText2: 'كمشروع عائلي شاب وطموح، نستلهم من النكهات المصرية، المحاصيل الموسمية، وبهجة إنشاء منتجات لذيذة ومغذية في آنٍ واحد.',
    aboutText3: 'كل منتج مصنوع بعناية لجمع الخيرات الطبيعية، الطعم الراقي، والتجربة المميزة التي يمكنك الاعتماد عليها.',
    stat1: 'عملاء راضون',
    stat2: 'مكونات طازجة',
